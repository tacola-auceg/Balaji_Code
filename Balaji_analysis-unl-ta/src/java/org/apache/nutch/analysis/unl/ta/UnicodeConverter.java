...
public class UnicodeConverter
{
	 ...
	 */
	static int noofrevert,noofconvert;
	public static String revert(byte b[])
	{
		noofrevert++;
		//////System.out.println("revert called"+noofrevert);
		////////System.out.println("INSIDE UNICODECONVERTER REVERT");
		short tab = 0;
		short temp = 0;
		short prefix = 0;
		short suffix = 0;
		...
		////////System.out.println("Bharath checking....");
		...
		for (i=0; i < b.length; i++)
		{
			...
			{ // Nontamil
				...
				tab = (short) b[i];
				////////System.out.println("In revert"+tab);
			} 
			else
			{ // Tamil
			...
			//-//////System.out.println("hello "+(char)tab);
			if(tab!=0)
	...
	{
		noofconvert++;
		////////System.out.println("convert called for word	:"+p+":"+noofconvert);
		////////System.out.println("INSIDE UNICODECONVERTER CONVERT");
		byte mycode = 0;
		byte temp = 0;
		boolean puttemp = false;
		boolean tamil = false;
		...
		//System.out.println("converting started...:"+p);
		if (p == null)
		{
			byte[] as = null;
		...
		//System.out.println("processing..:"+p.charAt(i) + "  "+j);
		...
		for (int l = 0; l < al.size(); l++)
		{
			...
			//System.out.print("The value of al"+ret[l] +" ");
		}
	...
	{
		//System.out.println("Inside checkLa");
		switch (nexttola)
		{
		case 3021:
			return false;
	...
	{
		//System.out.println("Inside Checking language");
		if (word.length() == 1)
		{
	...
	public static byte getProperInternalCode(char d)
	{
		//int k = (int) d;
		byte  mycode=0;
		//System.out.println("Get the internal Code for"+d);
		if ((d >= 2965) && (d <= 3001))
		{
		switch (d)
		{
		...
		////////System.out.println("internal mycode.."+mycode);		
		return mycode;
	}
	...
	public static void main(String args[])
	{
		...
		String words[]={"சென்று","வாழ்க்","மாளி","அன்படி","இன்படி","ஆததால்","அதால்","மாறு","ம்ம்","ந்ந்","வ்வ்"};
		for(int i=0;i<words.length;i++)
		{
			//////System.out.println(words[i]);
			byte bytep1[]=tab.convert(words[i]);
			String value=new String(bytep1);
