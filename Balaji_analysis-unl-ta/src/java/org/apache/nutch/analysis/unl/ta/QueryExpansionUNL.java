...
public class QueryExpansionUNL implements Serializable{
...
/*    public static void main(String args[])throws Exception
    {
    QueryExpansionUNL Q = new QueryExpansionUNL();
    int i= Q.EnconvertUNL("இந்தியா");
    //System.out.println("Hash Value"+ i);
    ArrayList arl=processUNLMW((Comparable)i);
