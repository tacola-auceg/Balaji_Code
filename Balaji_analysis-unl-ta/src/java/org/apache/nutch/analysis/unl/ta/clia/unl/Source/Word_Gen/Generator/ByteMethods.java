...
System.out.println("the lengthbbb"+b.length);
      byte[] a=null;byte[] aa={2};
      if(b.length==1 && b[0]==0)
      {//System.out.println("error from bytemethods b.length==1 && b[0]==0");
        a=c;}
      else if(c.length==1 && c[0]==0)
     { //System.out.println("error from bytemethods c.length==1 && c[0]==0");
        a=b;}
       ...
       else if(((b[b.length-1]==1)||(b[b.length-1]==2)||(b[b.length-1]==8)||(b[b.length-1]==6)||(b[b.length-1]==7)||(b[b.length-1]==10)||(b[b.length-1]==11)||(b[b.length-1]==12)) && ((c[0]==1)||(c[0]==3)||(c[0]==4)||(c[0]==5)||(c[0]==6)||(c[0]==7)||(c[0]==8)||(c[0]==9)||(c[0]==10)||(c[0]==11)||(c[0]==12)))  //rule 1 first endswith u and second starts with i or u remove the first u
       {
		   //||(c[0]==2)
        a= new byte[b.length+c.length+1];
         for(int i=0;i<b.length;i++)
      ...
      else if(((b[b.length-1]==3)||(b[b.length-1]==4)||(b[b.length-1]==9)||(b[b.length-1]==8)) && ((c[0]==1)||(c[0]==2)||(c[0]==3)||(c[0]==4)||(c[0]==5)||(c[0]==6)||(c[0]==7)||(c[0]==8)||(c[0]==9)||(c[0]==10)||(c[0]==11)||(c[0]==12)))  //rule 1 first endswith u and second starts with i or u remove the first u
  ...
  public byte[] verbaddarray(byte b[],byte[] c)
    {
       ...
       { //System.out.println("error from bytemethods c.length==1 && c[0]==0");
        ...
        else if(((b[b.length-1]==1)||(b[b.length-1]==2)||(b[b.length-1]==8)||(b[b.length-1]==6)||(b[b.length-1]==7)||(b[b.length-1]==10)||(b[b.length-1]==11)||(b[b.length-1]==12)) && ((c[0]==1)||(c[0]==2)||(c[0]==3)||(c[0]==4)||(c[0]==5)||(c[0]==6)||(c[0]==7)||(c[0]==8)||(c[0]==9)||(c[0]==10)||(c[0]==11)||(c[0]==12)))  //rule 1 first endswith u and second starts with i or u remove the first u
	         {
	          a= new byte[b.length+c.length+1];
	           for(int i=0;i<b.length;i++)
	               a[i]=b[i];
